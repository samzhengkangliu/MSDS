...
The model's R^2 is 0.4724 and the p value is 0.01568, which does a relatively good job on prediction. But it can be better off if we use more precise variable such as time. 


### Part 4: Bias Identification
1. Sources of bias: The shooting incidents may not be straightforward to be found and the cases reported for perpetrator are missing

2. Based on my partial analysis, it indicates that victims are most frequently happened in BROOKLYN and BRONX.
